/* ugid_functions.c
 * 
 * Implement a set of funcitons that convert user/group names to user/group IDs
 * and vice versa.
*/
#include <pwd.h>
#include <grp.h>
#include <ctype.h>
#include "ugid_functions.h"     /* Declares functinos defined here */
...
uid_t       /* Return UID corresponding to 'name', or -1 onf error */
userIdFromName(const char *name)
{
    ...
    if(endptr == '\0')                  /* Return a numeric string */
        return u;
